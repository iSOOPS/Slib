...
public class RedisUtil {
	 ...
	 *
	 * @param key rediskey k
	 * @param offset o
	 * @param value v v
	 * @return f 值,true为1, false为0
	 */
	 ...
	 * @param key rediskey
	 * @param value v
	 * @return f 之前已经存在返回false,不存在返回true
	 */
	...
	/**
	 * 删除集合中值等于value得元素
	 * index等于0, 删除所有值等于value的元素
	 * index大于0, 从头部开始删除第一个值等于value的元素
	 * index小与0, 从尾部开始删除第一个值等于value的元素
	 *
	 * @param key rediskey k
	 * @param index i
	 * @param value v v
